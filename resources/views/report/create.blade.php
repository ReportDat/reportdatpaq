                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="date_purchase" name="date_purchase"
                                value="{{ old('date_purchase', date('Y-m-d')) }}" required>
                            @error('date_purchase')
                    ...
                    <div class="col-lg-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="conveyor" id="conveyor">
                                ...
                                <option value="Coordinadora" {{ old('conveyor') == 'Coordinadora' ? 'selected' : '' }}>
                                    Coordinadora</option>
                                <option value="Envía" {{ old('conveyor') == 'Envía' ? 'selected' : '' }}>Envía</option>
                                <option value="Interrapidisimo"
                                    {{ old('conveyor') == 'Interrapidisimo' ? 'selected' : '' }}>Interrapidisimo</option>
                                <option value="Saferbo" {{ old('conveyor') == 'Saferbo' ? 'selected' : '' }}>Saferbo
                                </option>
                                <option value="Servientrega" {{ old('conveyor') == 'Servientrega' ? 'selected' : '' }}>
                                    Servientrega</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div class="col-auto" style="margin-top: 2.4rem!important;">
                            <div class="custom-control custom-checkbox mr-sm-2">
                                <input type="checkbox" class="custom-control-input" name="is_trustworthy"
                                    id="is_trustworthy" value="1" {{ old('is_trustworthy') == 1 ? 'checked' : '' }}>
